...
const arrowTowerRange = 3;

const cannonTowerCost = 20;
const cannonTowerRange = 4;
...
const mouseoverInterest = () => {
  ...
  descriptionBox.innerHTML = `INVESTMENT [2 GEMS]<br /><br />Remaining unused gold at end of a wave +10%<br /><br /><span id='toolTip'>Current Lvl [${interestLvl}]</span>`;
};
...
const mouseoverCost = () => {
  ...
  descriptionBox.innerHTML = `LOGISTICS [3 GEMS]<br /><br />Cost of all buildings -$1<br /><br /><span id='toolTip'>Current Lvl [${costLvl}]</span>`;
};
const mouseoutCost = () => {
  const descriptionBox = document.getElementById("descriptions");
  descriptionBox.style.color = "white";
...
const mouseoverRange = () => {
  ...
  descriptionBox.innerHTML = `INFRASTRUCTURE<br />[2 GEMS]<br /><br />Range of all future buildings +1 tile<br /><br /><span id='toolTip'>Current Lvl [${rangeLvl}]</span>`;
};
const mouseoutRange = () => {
  const descriptionBox = document.getElementById("descriptions");
  descriptionBox.style.color = "white";
...
const spawnWave = () => {
  ...
  display.innerHTML = `Current wave: ${waveNum}<br /><br />Number of mobs: ${
    waveNum + 4
  }<br />Mob Hp: ${enemyHealth}<br />$$ per mob: ${enemyHealth / 5}`;
  ...
  const spawnEnemy = () => {
    ...
    enemy.setAttribute("gold", `${enemyHealth / 5}`);
